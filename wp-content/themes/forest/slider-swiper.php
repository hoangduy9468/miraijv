		...
		<div id="slider-bg" data-stellar-background-ratio="0.5">
			<div class="container-fluid slider-container-wrapper">
				<div class="slider-container theme-default">
						...
						<div class="swiper-button-next slidernext swiper-button-white" style="display:none"></div>
						<div class="swiper-button-prev sliderprev swiper-button-white" style="display:none"></div>
			        </div>
			</div> 
		</div>
	<?php	
